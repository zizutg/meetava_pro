...
class AppTextStyles {
  static const TextStyle displayLarge = TextStyle(
      fontSize: 32.0, fontWeight: FontWeight.bold, color: AppColor.darkPurple);
  static const TextStyle displayMedium = TextStyle(
      fontSize: 28.0, fontWeight: FontWeight.bold, color: AppColor.deepPurple);
  ...
  static const TextStyle headlineLarge = TextStyle(
      fontSize: 20.0, fontWeight: FontWeight.bold, color: AppColor.darkPurple);
  static const TextStyle headlineMedium = TextStyle(
      fontSize: 18.0, fontWeight: FontWeight.bold, color: AppColor.deepPurple);
  static const TextStyle headlineSmall = TextStyle(
      fontSize: 16.0, fontWeight: FontWeight.bold, color: AppColor.medPurple);
  ...
  static const TextStyle titleSmall = TextStyle(
      fontSize: 12.0, fontWeight: FontWeight.normal, color: AppColor.medPurple);
  ...
  static const TextStyle labelLarge = TextStyle(
      fontSize: 14.0, fontWeight: FontWeight.bold, color: AppColor.deepPurple);
  static const TextStyle labelMedium = TextStyle(
      fontSize: 12.0, fontWeight: FontWeight.bold, color: AppColor.medPurple);
  static const TextStyle labelSmall = TextStyle(
      fontSize: 10.0, fontWeight: FontWeight.bold, color: AppColor.lightPurple);
}

class AppGaps {
  static const Widget vSmallGap = SizedBox(height: 8);
  static const Widget vMedGap = SizedBox(height: 16);
  static const Widget vLargeGap = SizedBox(height: 24);
  static const Widget vHugeGap = SizedBox(height: 32);

  static const Widget hSmallGap = SizedBox(width: 8);
  static const Widget hMedGap = SizedBox(width: 16);
  static const Widget hLargeGap = SizedBox(width: 24);
  static const Widget hHugeGap = SizedBox(width: 32);
}
